    ...
    try {
        ...
        try {
            ...
            if (chat) {
                ...
                if (!("sBye" in chat)) chat.sBye = "Bye bye babe see you later!"
                if (!("sDemote" in chat)) chat.sDemote = ""
                if (!("simi" in chat)) chat.simi = false
                if (!("sPromote" in chat)) chat.sPromote = ""
                if (!("sWelcome" in chat)) chat.sWelcome = "Hey babe! Welcome to our Group❤️"
                ...
                global.db.data.chats[m.chat] = {
                    ...
                    isBanned: false,
                    nsfw: false, 
                    sBye: "Bye bye babe see you later!",
                    sDemote: "",
                    simi: false,
                    sPromote: "",
                    sticker: false,
                    sWelcome: "Hey babe! Welcome to our Group❤️",
                    useDocument: false,
                    viewOnce: true,
                    viewStory: true,
                    welcome: true,
            ...
            if ((usedPrefix = (match[0] || "")[0])) {
               ...
               let xp = 'exp' in plugin ? parseInt(plugin.exp) : 17 // XP Earning per command
                ...
                try {
                    ...
                    if (!isPrems)
                        m.credit = m.credit || plugin.credit || true
                } catch (e) {
                    // Error occured
                    m.error = e
                    console.error(e)
            ...
            if (chat.welcome) {
              ...
              for (let user of participants) {
                ...
                try {
                  ...
                  pp = 'https://i.postimg.cc/6Q3kjwfK/jennie.jpg'; // Assign default image URL
                  ppgp = 'https://i.postimg.cc/6Q3kjwfK/jennie.jpg'; // Assign default image URL
                } finally {
                  ...
                  let welcomeApiUrl = `https://wecomeapi.onrender.com/welcome-image?username=${encodeURIComponent(
                    ...
                    'https://i.postimg.cc/hj6GYGb6/hot.jpg'
                  )}`;
                  ...
                  try {
                    ...
                    this.sendMessage(id, {
                        ...
                        mentionedJid: [user],
                        externalAdReply: {
                        title: "Im Jennie, made by jeff, im here to assist you.",
                        body: "Hey babe! Welcome to our Group❤️ click on my pic and start your journey to become the Legend.",
                        thumbnailUrl: welcomeApiUrl,
                        sourceUrl: 'https://i.postimg.cc/brjg5nLy/bank.png',
                        mediaType: 1,
                ...
                try {
                  ...
                  try {
                    ...
                    this.sendMessage(id, {
                        ...
                        externalAdReply: {
                        title: "Im Jennie, made by jeff, im here to assist you.",
                        body: "Bye bye babe see you later!❤️ click on my pic and start your journey to become the Legend",
